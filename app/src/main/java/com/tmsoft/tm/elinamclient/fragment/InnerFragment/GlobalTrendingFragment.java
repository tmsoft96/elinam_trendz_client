 ...
 */
public class GlobalTrendingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_s_global_trending, container, false);
        ...
        recyclerView = view.findViewById(R.id.recycler_globalTending);
        recyclerView.setHasFixedSize(true);
        gridLayoutManager = new GridLayoutManager(view.getContext(), mNoofColums);
        gridLayoutManager.setReverseLayout(false);
        recyclerView.setLayoutManager(gridLayoutManager);

        details = view.findViewById(R.id.fragmentGlobalTrending_details);
        showDetails = view.findViewById(R.id.fragmentGlobalTrending_showDetails);
        hideDetails = view.findViewById(R.id.fragmentGlobalTrending_hideDetails);
        refresh = (SwipeRefreshLayout) view.findViewById(R.id.fragmentGlobalTrending_refreshs);
    ...
    private void showItems() {
        ...
        Query query = databaseReference.orderByChild("ProductCategory").startAt("Global Trending").endAt("Global Trending + \uf8ff");
