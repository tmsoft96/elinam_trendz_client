...
public class ShowCartWhenClickActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myToolBar = findViewById(R.id.showCartWhenClick_toolbar);
        setSupportActionBar(myToolBar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Confirm Cart");

        mAuth = FirebaseAuth.getInstance();
        getCurrentUserID = mAuth.getCurrentUser().getUid();
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Cart Order")
        ...
        recyclerView = findViewById(R.id.showCartWhenClick_recycler);
