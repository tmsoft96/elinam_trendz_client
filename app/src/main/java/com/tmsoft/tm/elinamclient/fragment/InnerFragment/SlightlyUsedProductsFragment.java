 ...
 */
public class SlightlyUsedProductsFragment extends Fragment {
    View view;
    ...
    public SlightlyUsedProductsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_s_slightly_used_products, container, false);
        ...
        recyclerView = view.findViewById(R.id.recycler_slightlyUsedProducts);
        recyclerView.setHasFixedSize(true);
        gridLayoutManager = new GridLayoutManager(view.getContext(), mNoofColums);
        gridLayoutManager.setReverseLayout(false);
        recyclerView.setLayoutManager(gridLayoutManager);

        details = view.findViewById(R.id.fragmentSlightly_details);
        showDetails = view.findViewById(R.id.fragmentSlightly_showDetails);
        hideDetails = view.findViewById(R.id.fragmentSlightly_hideDetails);
        refresh = (SwipeRefreshLayout) view.findViewById(R.id.fragmentSlightly_refreshs);
    ...
    private void showItems() {
        ...
        Query query = databaseReference.orderByChild("ProductCategory").startAt("Slightly Used Products").endAt("Slightly Used Products + \uf8ff");
