 ...
 */
public class BulkPurchaseFragment extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_s_order_for_me, container, false);
        ...
        recyclerView = view.findViewById(R.id.recycler_orderForMe);
        recyclerView.setHasFixedSize(true);
        gridLayoutManager = new GridLayoutManager(view.getContext(), mNoofColums);
        gridLayoutManager.setReverseLayout(false);
        recyclerView.setLayoutManager(gridLayoutManager);

        details = view.findViewById(R.id.fragmentOrderOfMe_details);
        showDetails = view.findViewById(R.id.fragmentOrderOfMe_showDetails);
        hideDetails = view.findViewById(R.id.fragmentOrderOfMe_hideDetails);
        refresh = view.findViewById(R.id.fragmentOrderOfMes_refresh);
    ...
    private void showItems() {
        ...
        Query query = databaseReference.orderByChild("ProductCategory").startAt("Bulk Purchase").endAt("Bulk Purchase + \uf8ff");
